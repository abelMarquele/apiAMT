    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line_nr_1', models.CharField(blank=True, default='', max_length=50, verbose_name='Routa')),
                ('bus_nr', models.IntegerField(blank=True, default='', verbose_name='Nº de Autocarro')),
                ('spz_1', models.CharField(blank=True, default='', max_length=50, verbose_name='Matrícula')),
                ...
                ('spz', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='corridorBus', to='index_translation.bus')),
            ],
        ),
    ]
