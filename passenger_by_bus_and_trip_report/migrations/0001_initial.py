    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route_reg_no1', models.IntegerField(blank=True, default='', max_length=50, verbose_name='Direcção do Autocarro')),
                ('route_reg_no', models.IntegerField(blank=True, default='', max_length=50, verbose_name='Direcção do Autocarro')),
                ...
                ('money_value', models.DecimalField(blank=True, decimal_places=3, default='', max_digits=7, verbose_name='Valor Pago')),
                ('transaction_count', models.IntegerField(blank=True, default='', verbose_name='Nº de Transações Diárias')),
                ('money_value1', models.DecimalField(blank=True, decimal_places=3, default='', max_digits=7, verbose_name='Total do valor pago')),
                ('transaction_count2', models.IntegerField(blank=True, default='', verbose_name='Total de transações diárias')),
                ('money_value3', models.DecimalField(blank=True, decimal_places=3, default='', max_digits=7, verbose_name='Total de transações diárias')),
